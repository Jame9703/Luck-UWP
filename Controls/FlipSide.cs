...
namespace Luck.Controls
{
    public sealed class FlipSide : Control
    {
        ...
        private void InitComposition()
        {
            ...
            springAnimation1.DampingRatio = 0.4f;
            springAnimation1.Period = TimeSpan.FromMilliseconds(80);
            springAnimation1.FinalValue = 180f;

            springAnimation2 = compositor.CreateSpringScalarAnimation();
            springAnimation2.DampingRatio = 0.4f;
            springAnimation2.Period = TimeSpan.FromMilliseconds(80);
